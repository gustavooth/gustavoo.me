  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl lg:text-7xl tracking-tight text-text-primary leading-[1.05] max-w-[8ch] mx-auto">
          Playground <span className="font-display italic">visual</span>
        </h2>
        <p className="text-sm md:text-base text-muted max-w-xs mt-4">
      ...
      {/* Camada 2: colunas parallax.
          justify-between + max-w nas colunas empurra cada coluna para a sua
          borda, deixando o texto pinado livre no centro. */}
      <div className="absolute inset-0 z-20 pointer-events-none">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-10 h-full">
          <div className="flex justify-between">
            <div
              ref={colARef}
              className="flex flex-col items-start gap-16 pt-[30vh] w-[22%] max-w-[230px] lg:max-w-[280px]"
            >
              {colA.map((it, i) => (
            ...
            <div
              ref={colBRef}
              className="flex flex-col items-end gap-16 pt-[55vh] w-[22%] max-w-[230px] lg:max-w-[280px]"
            >
              {colB.map((it, i) => (
